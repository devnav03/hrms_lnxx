            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card show_datas" style="display: none;">
                        ...
                        <div class="card mb-4 approval-authority-view" style="display:none">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <a class="btn btn-success float-right add-more btn-sm remove_approval save_approval">+ Add Approval Authority</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    if(datas.length>0){
                                        for (var i = 0; i < datas.length; i++) {
                                            html += '<tr><td>'+(i+1)+'</td>'+
                                                ...
                                                '<td><a href="" class="text-danger delete-button"><i class="fa fa-trash"></i></a></td>'+
                                            '</tr>';
                                        }
