...
<div class="main-panel">
    <div class="content-wrapper">
        @if(session()->has('max_hundred'))
            <p style="color: #f00;font-size: 16px;">You can add maximum amount percentage 100</p>    
        @endif
        <div class="row">
                        ...
                        <form class="forms-sample row" action="{{url('salary-head-master')}}" method="POST">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="earning_deduction" name="earning_deduction" required>
                                        <option value="1" @if(!empty($update->earning_deduction)) @if($update->earning_deduction== 1) selected @endif @endif>Earning</option>
                                        <option value="2" @if(!empty($update->earning_deduction)) @if($update->earning_deduction== 2) selected @endif @endif>Deduction</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" @if(!empty($update)) value="{{ $update->header_name }}" @else value="" @endif class="form-control" id="header_name" name="header_name" placeholder="Enter Head Name" required>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Percentage *</label>
                                    <input type="number" min="1" class="form-control" id="percentage" @if(!empty($update)) value="{{ $update->amount_percent }}" @else value="" @endif name="percentage" placeholder="Enter Percentage" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                        ...
                        <table class="examples display table-sm" style="width:100%">
                            ...
                            @if(!empty($earning))
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('salary-head-master-edit', $rows->id) }}" class="text-primary mx-2"><i class="fa fa-edit"></i></a><a href="{{ route('salary-head-master-del',$rows->id) }}" class="text-danger delete-button"><i class="fa fa-trash"></i></a></td>
                                </tr>
                                @endforeach
                            @endif
                            </tbody>
